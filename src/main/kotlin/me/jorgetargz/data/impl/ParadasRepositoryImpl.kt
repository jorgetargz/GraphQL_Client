...
class ParadasRepositoryImpl : BaseRepository(), ParadasRepository {

    override fun getParadasByLineaId(lineaId: Int) = executeGraphQLQuery(
    ...
    override fun createParada(parada: Parada): Flow<NetworkResult<Parada>> = executeGraphQLMutation(
    ...
    override fun updateParada(parada: Parada): Flow<NetworkResult<Parada>> = executeGraphQLMutation(
    ...
    override fun deleteParada(parada: Parada): Flow<NetworkResult<Parada>> = executeGraphQLMutation(
